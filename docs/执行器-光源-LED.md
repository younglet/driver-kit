---
title: LED
description: DriverKit · 执行器分类下的 LED 模块文档：工作原理、常见型号与参考价格、硬件接线、驱动代码、调试方法与 FAQ。
keywords: LED,执行器,光源,DriverKit,驱动派,嵌入式,硬件驱动,选型,接线,原理,代码示例,调试,WS2812,SK6812,APA102,RGB灯带
category: 执行器
field: 光源
module: LED
---
